...
*/
  ...
  allocator_type get_allocator() const { return (allocating); }

  /**_**_**_**_**_**_**_* Member functions  **_**_**_**_**_**_**_**_**_**_*/

  /* -----------------------:----------------------- { Iterators
   * }-----------------------:-----------------------:*/
  iterator begin() { return iterator(this->start_iter); }
  const_iterator begin() const { return const_iterator(this->start_iter); }
  // iterator begin()
  ...
  // 	return const_iterator(this->start_iter);
  // }
  iterator end() { return (iterator(&start_iter[this->size_param])); }
  ...
  /* -----------------------:-----------------------: { Capacity }
   * -----------------------:-----------------------:*/
  size_type size() const { return (this->size_param); }
  ...
  size_type capacity() const { return (this->capacity_param); }
  ...
  void reserve(size_type n) {
    if (n > max_size()) {
      throw std::length_error(
          "Length error: The size requested is greater than the maximum size ");
    }
    if (n > capacity_param) {
  ...
  /* -----------------------:-----------------------:{ Element access
   * }:-----------------------:-----------------------:*/
  reference operator[](size_type n) { return (start_iter[n]); }
  const_reference operator[](size_type n) const { return (start_iter[n]); }
  ...
  const_reference front(void) const { return (*start_iter); }
...
void swap(vector<T, Alloc> &x, vector<T, Alloc> &y) {
  // std::cout << "swap is called swap(vector<T, Alloc> &x, vector<T, Alloc> &y)
  // " << std::endl;
  x.swap(y);
}
