...
/*   Updated: 2023/01/28 12:38:44 by atabiti          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// real.push_back(1222);
	it = real.insert(real.begin()+11, 1337);
	...
	// vec1.push_back(1222);
	iteratormain = vec1.insert(vec1.begin()+11, 1337); // problem in iterator + operator  problem if position beyond capacity
												// it1 = vec1.begin();
